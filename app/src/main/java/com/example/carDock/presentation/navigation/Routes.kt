...
sealed class InnerCarListRoute(val route: String) {
    object CarListPage : InnerCarListRoute("/")
    object CarDetailsPage : InnerCarListRoute("/car_details_page")
    object CartPage : InnerCarListRoute("/cart")
}